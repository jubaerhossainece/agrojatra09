<x-layouts.member title="Edit Deposit">
    ...
    <div class="max-w-2xl space-y-4">
        ...
        <a href="{{ route('member.deposits.index') }}" class="text-sm text-gray-500 hover:text-gray-700">← Back to
            Deposits</a>
        ...
        <form method="POST" action="{{ route('member.deposits.update', $deposit) }}" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Amount (BDT) <span
                                class="text-red-500">*</span></label>
                        <input type="number" name="amount" value="{{ old('amount', $deposit->amount) }}" min="1"
                            step="1" required
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Deposit Date <span
                                class="text-red-500">*</span></label>
                        <input type="text" data-datepicker name="deposit_date"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Bank Reference / Transaction ID
                            <span class="text-red-500">*</span></label>
                        <input type="text" name="bank_reference"
                            value="{{ old('bank_reference', $deposit->bank_reference) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="receipt_number"
                            value="{{ old('receipt_number', $deposit->receipt_number) }}"
